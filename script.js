...
// ===== SYNTAX CARD ANIMATIONS =====
document.querySelectorAll('.syntax-card').forEach((card, index) => {
    card.addEventListener('mouseenter', () => {
        if (prefersReducedMotion) return;
        
        // Icon animation
        anime({
            targets: card.querySelector('.syntax-icon'),
            scale: [1, 1.2, 1.1],
            rotate: [0, 15, -15, 0],
            duration: 600,
        ...
        anime({
            ...
            boxShadow: [
                ...
                '0 30px 100px rgba(124, 58, 237, 0.7)',
                '0 25px 80px rgba(6, 182, 212, 0.5)'
            ],
            duration: 1000,
            easing: 'easeInOutQuad'
        ...
        anime({
            targets: card.querySelectorAll('.syntax-code .keyword'),
            color: ['#7C3AED', '#06B6D4', '#7C3AED'],
            duration: 800,
